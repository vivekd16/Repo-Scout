...
const Top = () => {
  ...
  const handleRefresh = () => {
    ...
    toast({
      title: 'Refreshed',
      description: 'Top repositories have been updated.',
    });
  };
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-foreground">Top Repositories</h1>
            </div>
            <p className="text-muted-foreground">
              The most starred and established repositories on GitHub
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Show top repositories for a specific programming language
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold">
              {selectedLanguage ? `Top ${selectedLanguage} Repositories` : 'Top Repositories'}
            </h2>
