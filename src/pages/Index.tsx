    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      {isInitialLoading ? (
        <div className="h-screen flex flex-col items-center justify-center">
          <Loader />
          <p className="text-slate-600 mt-4">Loading Repo Scout...</p>
        </div>
      ) : (
        <>
          {/* Header */}
              ...
              <div className="mb-8">
                ...
                {isLoading ? (
                  <div className="text-center py-12">
                    <Loader />
                    <p className="text-slate-600 mt-4">Searching GitHub for the latest issues and fetching contribution guides...</p>
                  </div>
                ) : issues.length > 0 ? (
